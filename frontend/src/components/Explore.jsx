...
const [search, setsearch] = useState('')
  ...
  return (
    <div>
       {/* searchField */}
       <div className='flex gap-3 items-center mx-[430px] my-5 p-4  rounded-full border-2 border-gray-300  ' >
       <IoSearchOutline size={28}/>
       <input value={search} onChange={(e)=>setsearch(e.target.value)} type="text" placeholder='Search here..' className='flex-1' />
       {/* cards */}
       </div>
